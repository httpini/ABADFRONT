            ...
            {/* <div className='flex xl:block items-center'> */}
                <div className='mt-10 flex items-start flex-wrap md:flex-nowrap justify-center w-full xl:pb-20'>
                    <div className='w-full'>
                        ...
                        <p className='text-sm w-[100%] md:w-[70%] xl:w-[70%]'> Participan anualmente un total de 78 equipos divididos en dos categorías, cada una de ellas se divide entre las divisiones Primera y Segunda, con ascensos y descensos (directos y por promoción)</p>
                        <br />
